...
public class Constants {
     ...
     *
     */
    public static final String LOGINURL = "http://10.10.30.225/attendance/login.php";
    public static final String INSERTATTEND = "http://10.10.30.225/attendance/insertAttendance.php";
    public static final String VIEWATTENDANCE = "http://10.10.30.225/attendance/viewAttendance.php";
    public static final String QUICKATTENDANCE = "http://10.10.30.225/attendance/quickAttendance.php";
